...
$tests = @(
    ...
    @{ Name="ctrlc_counter"; Config="configs\sample.ctrlc_counter.ps1"; Interactive=$true; Notes="Press Ctrl+C three times within 2 seconds; keep presses at least about 250ms apart so debounce does not suppress them" },
